...
-- CreateIndex
CREATE INDEX "usage_logs_field_id_idx" ON "usage_logs"("field_id");
...
-- AddForeignKey
ALTER TABLE "usage_logs" ADD CONSTRAINT "usage_logs_field_id_fkey" FOREIGN KEY ("field_id") REFERENCES "fields"("id") ON DELETE SET NULL ON UPDATE CASCADE;
